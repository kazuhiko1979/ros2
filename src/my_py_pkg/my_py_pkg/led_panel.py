...
class LEDPanelNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('led_states', [0, 0, 0]) # Default states for 3 LEDs
    ...
    def callback_set_led(self, request: SetLed.Request, response: SetLed.Response) -> SetLed.Response:
